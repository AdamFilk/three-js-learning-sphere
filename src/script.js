...
// Objects
const sphereGeometery = new THREE.SphereBufferGeometry(
  0.5,
  32,
  16,
  0,
...
const pointLight2 = new THREE.PointLight(0xfff0000, 0.1);
pointLight2.position.set(5.83, 1.7, -1.45);
...
// const pointLightHleper = new THREE.PointLightHelper(pointLight3, 1);
// scene.add(pointLightHleper);
